...
class _HomeScreenWidgetState extends State<HomeScreenWidget> {
  ...
  BehaviorSubject<bool> rxIsLoaded = BehaviorSubject();


  @override
  void initState() {
    super.initState();
    rxIsLoaded.sink.add(false);
      ...
      if (isInternetAvailable) {
        ...
        if (isLastPage) {
          ...
          _pagingController.appendLastPage(listData);
            ...
            propertyListData.addAll(listData);
            _pagingController.appendPage(listData, nextPageKey.toInt());
        }
      } else {
        showDialog(
          context: context,
        ...
        child: Column(
          ...
          children: [
            Container(
             ...
             StreamBuilder<bool>(
               stream: rxIsLoaded.stream,
               builder: (context, snapshot) {
                return rxIsLoaded.value ?
                  Expanded(
                  child:
                  PagedListView<int, dynamic>(
                    pagingController: _pagingController,
                    builderDelegate: PagedChildBuilderDelegate<dynamic>(
                      itemBuilder: (context, item, index) => buildCardItem(index),
                    ),
                  ),
                    ):Expanded(
                 child: SizedBox(
                          ...
                          child: Padding(
                              ...
                              child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    height: 40,
                                    decoration: BoxDecoration(
                                      color:  propertyListData[index]["isBookmarked"] != null && propertyListData[index]["isBookmarked"]
                                          ? Color(
                                          0x4DFF0000)
                                          : Color(
                                          0x4D000000),
